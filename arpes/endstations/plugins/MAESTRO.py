...
class MAESTROARPESEndstationBase(
    ...
    # J: Unnecessary if commented changes within are made
    ...
    # J: this shouldn't have to be here
    ...
    # J: Should be in postprocess_scan
...
class MAESTROMicroARPESEndstation(MAESTROARPESEndstationBase):
    ...
    # J: this shouldn't be necessary. If it is, move it into RENAME_KEYS
    # RENAME_COORDS = {
    #     "X": "x",
    #     "Y": "y",
    #     "Z": "z",
